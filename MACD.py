...
def main():
    ...
    last_macd_signals = {symbol: {interval: None for interval in INTERVALS} for symbol in symbols}
    ...
    while True:
        for interval in INTERVALS:
            for symbol in symbols:
                ...
                if macd_signal:
                    last_signal = last_macd_signals[symbol].get(interval)
                    if macd_signal != last_signal:
                        data = {}
                        ...
                        last_macd_signals[symbol][interval] = macd_signal
