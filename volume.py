...
def main():
    ...
    while True:
        ...
        if len(price_data['bitcoin']) == 2:
            ...
            if last_checked_btc_level is None or bitcoin_current_level != last_checked_btc_level:
        ...
        if len(price_data['ethereum']) == 2:
            ...
            if last_checked_eth_level is None or ethereum_current_level != last_checked_eth_level:
